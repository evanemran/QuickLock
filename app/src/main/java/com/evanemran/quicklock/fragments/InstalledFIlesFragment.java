package com.evanemran.quicklock.fragments;
...
import com.evanemran.quicklock.listeners.ClickListener;
import com.example.locktank.R;
import com.evanemran.quicklock.adapters.PackageListAdapter;
...
public class InstalledFIlesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (dbList.isEmpty() && !isLockedFiles){
